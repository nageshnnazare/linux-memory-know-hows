 ...
 * Exit status: 0
 * Output:
 * malloc(64)              = 0x55b798a3b2a0  16-aligned? 1  64-aligned? 0
 * aligned_alloc(64, 128)  = 0x55b798a3c300  64-aligned? 1
 * posix_memalign(4096,4K) = 0x55b798a3d000  page-aligned? 1
 * memalign(32, 100)       = 0x55b798a3c3c0  32-aligned? 1
 * aligned_alloc(64, 100)  = 0x55b798a3c3c0  (UB, may be NULL)
