 ...
 * Exit status: 0
 * Output:
 * stack                   va=0x7fff86a824e4  present=1 swap=0 filebak=0 excl=1  pfn=0x0
 * bss                     va=0x55f5efb7b018  present=1 swap=0 filebak=0 excl=1  pfn=0x0
 * data                    va=0x55f5efb7b010  present=1 swap=0 filebak=0 excl=1  pfn=0x0
 * malloc heap             va=0x55f62bea12a0  present=1 swap=0 filebak=0 excl=1  pfn=0x0
 * mmap anon               va=0x7f2611eca000  present=1 swap=0 filebak=0 excl=1  pfn=0x0
 * text (main)             va=0x55f5efb78439  present=1 swap=0 filebak=1 excl=1  pfn=0x0
